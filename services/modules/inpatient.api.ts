...
export interface Hospitalization {
  ...
  diagnosis: string | null; admissionNotes: string | null; cage: string | null;
...
export const inpatientAPI = {
  ...
  admit: async (data: { petId: string | number; clientId: string | number; appointmentId?: string | number; inpatientNo?: string; diagnosis?: string; admissionNotes?: string; cage?: string; clinicianId?: string | number }, options?: RequestOptions): Promise<ApiResponse<{ hospitalization: Hospitalization }>> =>
