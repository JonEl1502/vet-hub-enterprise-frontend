...
export interface InventoryItemAnalytics {
  ...
  ledger: { id: string; type: string; quantity: number; balanceAfter: number; balanceBefore?: number | null; balanceRecorded?: boolean; batchNumber: string | null; reference: string | null; at: string }[];
}
