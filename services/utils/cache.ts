...
const PERSISTENT_DATA_TYPES = ['clients', 'pets', 'appointments', 'transactions', 'services', 'categories', 'inventory', 'suppliers', 'purchase-orders', 'supplier-products', 'supplier-orders', 'wallets', 'wallet-ledger'];
