...
export const KEY_LABEL: Record<string, string> = {
  ...
  'client:messages': 'Message your clinic',
  'client:community': 'Community access',
  'client:marketplace': 'Farm produce & livestock marketplace',
  // ── Livestock ────────────────────────────────────────────────────────────
  'livestock:dashboard': 'Farm dashboard',
  'livestock:farms': 'Animal farm',
  'livestock:animal-groups': 'Herds & flocks',
  'livestock:animal-register': 'Named animal register',
  'livestock:records': 'Farm record book',
  'livestock:treatments': 'Treatment & withdrawal register',
