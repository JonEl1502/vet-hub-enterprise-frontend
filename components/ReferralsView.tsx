  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-500 pb-20">
      ...
      <div className="overflow-x-auto no-scrollbar">
        <div className="flex bg-slate-100 dark:bg-zinc-900 p-1.5 rounded-2xl border border-slate-200 dark:border-zinc-800 self-start inline-flex min-w-max">
          {[
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 md:px-8 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${
