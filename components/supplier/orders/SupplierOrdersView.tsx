...
const SupplierOrdersView: React.FC<SupplierOrdersViewProps> = ({ setView }) => {
  ...
  // Read the admin's currently-narrowed supplier scope; we hide the supplier
  // pill on each card when narrowed to exactly one supplier (it would just
  // be a noisy repeat of the page header).
                ...
                <div className="flex items-start justify-between px-4 pt-4 pb-3 border-b border-slate-100 dark:border-zinc-800 gap-2">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      {showSupplierColumn && o.supplier?.name && (
