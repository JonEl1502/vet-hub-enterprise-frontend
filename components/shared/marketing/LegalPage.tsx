      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm py-4">
        <div className="max-w-3xl mx-auto px-6 flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 ml-2">
            <div className="w-8 h-8 rounded-xl bg-[#1C7A5B] flex items-center justify-center p-1.5"><img src="/vethubcore-mark-white.svg" alt="VetHubCore" className="w-full h-full object-contain" /></div>
      ...
      <footer className="bg-[#144E35] text-white/50 py-8">
        <div className="max-w-3xl mx-auto px-6 flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-xl bg-[#1C7A5B] flex items-center justify-center p-1"><img src="/vethubcore-mark-white.svg" alt="VetHubCore" className="w-full h-full object-contain" /></div>
