...
const BillingView: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {activeTab === 'documents' && (
        /* Shared with the supplier billing page — see BillingDocumentsPanel.
           Both audiences render the SAME table; only the rows and one line of
           copy differ. */
